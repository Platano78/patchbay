...
class ModuleArguments:
    ...
    tts: Optional[Literal["melo", "chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "remote-speech"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or "
            "'remote-speech' (any server speaking OpenAI's /v1/audio/speech protocol, with automatic "
            "fallback to pocket). Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
